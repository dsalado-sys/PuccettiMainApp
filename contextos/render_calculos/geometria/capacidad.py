    ...
    *,
    ...
    for i, p in enumerate(plantas):
        ...
        if cat == "sotano":
            ...
            # PB usa su tipología y descuenta local; el resto (tipo / ático) usa la
            # tipología de las plantas tipo y no descuenta local.
            es_pb = cat == "pb"
            perfil = perfil_pb if es_pb else perfil_tipo
