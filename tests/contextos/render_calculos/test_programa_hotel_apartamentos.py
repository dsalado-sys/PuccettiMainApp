...
def test_apartamento_salon_comedor_dormitorio_cocina_bano():
    ...
    # El salón sigue en su base "hasta 4 personas" (sin adicional: plazas_dorm = 4).
    ...
    assert est["salon_comedor"].area_min_m2 == pytest.approx(16.0)   # 4L, salón ≤4 personas → sin adicional
